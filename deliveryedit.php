    ...
    <div class="container">
        ...
        <form method="post" action="profileupdate.php"> 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="number" name="number" value="<?php echo $user['address']; ?>">
            </div>

            <input class="btn btn-primary" name="submit" type="submit" value="Update Profile">
            <button class="btn btn-danger" onclick="location.href='checkout.php';" type="button">Cancel</button>
        </form>
    </div>
</body>
