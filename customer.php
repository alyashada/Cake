        ...
        <div class="table-container">
            ...
            <div class="search-form d-flex justify-content-center">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="GET" class="form-inline my-2 my-lg-0">
                    <input type="text" class="form-control mr-sm-2" name="searchTerm" placeholder="Search Role Name" value="<?php echo isset($_GET['searchTerm']) ? $_GET['searchTerm'] : ''; ?>">
                    <button type="submit" class="btn btn-primary mr-2">Search</button>
                    <a href="addcust.php" class="btn btn-primary">Add New Customer</a>
                </form>
                <br>
            </div>
            <br>
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $query = "SELECT user.*, roles.roles_name FROM user
                              ...
                              WHERE user.role_id IN (2, 3) AND (user.name LIKE ? OR roles.roles_name LIKE ?)";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><a href='custedit.php?id=" . $row['id'] . "' class='btn btn-primary'>Edit</a></td>";
                        echo "<td><a href='custdelete.php?id=" . $row['id'] . "' class='btn btn-danger'>Delete</a></td>";
                        echo "</tr>";
                    }
